...
<fieldset>
    ...
    <div class="content">
        <div class="mt-checkbox-inline">
          <label class="mt-checkbox mt-checkbox-outline"><input type="checkbox" name="admin" value="admin" checked disabled> 后台管理模块 <span></span></label>
          <label class="mt-checkbox mt-checkbox-outline"><input type="checkbox" name="content" value="content" checked disabled> 内容模块 <span></span></label>
          <label class="mt-checkbox mt-checkbox-outline"><input type="checkbox" name="wap" value="wap" checked disabled> 手机模块 <span></span></label>
          <label class="mt-checkbox mt-checkbox-outline"><input type="checkbox" name="member" value="member" checked disabled>会员模型 <span></span></label>
          <label class="mt-checkbox mt-checkbox-outline"><input type="checkbox" name="pay" value="pay" checked disabled> 财务模块 <span></span></label>
          <label class="mt-checkbox mt-checkbox-outline"><input type="checkbox" name="special" value="special" checked disabled> 专题模块 <span></span></label>
          <label class="mt-checkbox mt-checkbox-outline"><input type="checkbox" name="search" value="search" checked disabled> 全文搜索 <span></span></label>
        </div>
    </div>
</fieldset>
...
<?php
    ...
    <label class="mt-checkbox mt-checkbox-outline"><input type="checkbox" name="selectmod[]" value="<?php echo $module?>" class="checkboxes"> <?php echo $CMS_MODULES['modulename'][$i]?>模块 <span></span></label>
    <?php }?>
        </div>
    </div>
</fieldset>
