...
<fieldset>
    ...
    <div class="content">
        <table width="100%" cellspacing="1" cellpadding="0" >
            ...
            <td><input name="tablepre" type="text" id="tablepre" value="<?php echo $tablepre?>" class="input-text" />  <img src="./images/help.png" style="cursor:pointer;" onmouseover="layer.tips('如果一个数据库安装多个cms，请修改表前缀',this,{tips: [1, '#000']});" onmouseout="layer.closeAll();" align="absmiddle" />
