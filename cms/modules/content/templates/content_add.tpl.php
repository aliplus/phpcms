...
<form name="myform" id="myform" action="?m=content&c=content&a=add" onsubmit="return checkall()" method="post" enctype="multipart/form-data">
...
<input value="<?php echo L('save_continue');?>" type="submit" name="dosubmit_continue" id="dosubmit_continue" class="dialog" style="width:130px;" title="Alt+X">
<input value="<?php echo L('c_close');?>" type="button" name="close" id="close" onclick="close_window();" class="dialog" style="width:70px;">
</div>
</form>
