...
<script type="text/html" id="topBtn">
    ...
    <?php if($workflow_menu) { ?><button type="button" class="layui-btn layui-btn-danger layui-btn-sm" onclick="reject_check()"><?php echo L('reject');?></button>
...
function reject_check(type) {
	if(type==1) {
		...
		if(str==0) {
			Dialog.alert('<?php echo L('you_do_not_check');?>');
			return false;
		}
