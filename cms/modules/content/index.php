...
class index {
	...
	public function init() {
		...
		if (pc_base::_is_mobile($siteid) && $sitelist[$siteid]['mobileauto']) {
			if (!file_exists(PC_PATH.'templates'.DIRECTORY_SEPARATOR.$style.DIRECTORY_SEPARATOR.'wap'.DIRECTORY_SEPARATOR.'index.html')) {
	...
	public function show() {
		...
		$sitelist  = getcache('sitelist','commons');
		if (pc_base::_is_mobile($siteid) && $sitelist[$siteid]['mobileauto']) {
			if (!file_exists(PC_PATH.'templates'.DIRECTORY_SEPARATOR.$style.DIRECTORY_SEPARATOR.'wap'.DIRECTORY_SEPARATOR.$template.'.html')) {
