  	...
  	<tr>
   	...
   	<tr>
	    ...
	    <td colspan=3><div class="mt-radio-inline">
          ...
          <label class="mt-radio mt-radio-outline"><input type="radio" name="sqlcharset" value="latin1"> LATIN1 <span></span></label>
          <label class="mt-radio mt-radio-outline"><input type="radio" name="sqlcharset" value='utf8'> UTF-8 <span></span></label>
        </div></td>
  	</tr>
  	<tr>
...
<input type="button" class="button" name="dosubmit" onclick="dr_bfb_submit('<?php echo L('batch_utf8')?>', 'myform', '<?php echo SELF;?>?m=admin&c=database&a=public_add&operation=ut&pdo_name=<?php echo $pdo_name?>')" value="<?php echo L('batch_utf8')?>"/>
</div>
<?php 
}
?>
