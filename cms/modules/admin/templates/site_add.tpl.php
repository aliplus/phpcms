...
<fieldset>
  ...
  <tr>
    ...
    <td class="y-bg"><input type="text" class="input-text" name="name" id="name" size="70" /></td>
  </tr>
  <tr>
    <th><?php echo L('site_dirname')?>：</th>
    <td class="y-bg"><input type="text" class="input-text" name="dirname" id="dirname" size="70" /></td>
  </tr>
    <tr>
    <th><?php echo L('site_domain')?>：</th>
    <td class="y-bg"><input type="text" class="input-text" name="domain" id="domain"  size="70"/></td>
  </tr>
  <tr>
    <th><?php echo L('html_home')?>：</th>
    <td class="y-bg">
      <div class="mt-radio-inline">
        <label class="mt-radio mt-radio-outline"><input type="radio" name="ishtml" value="1" checked> <?php echo L('yes');?> <span></span></label>
        <label class="mt-radio mt-radio-outline"><input type="radio" name="ishtml" value="0"> <?php echo L('no');?> <span></span></label>
      </div>
    </td>
  </tr>
</table>
...
<fieldset>
  ...
  <tr>
    ...
    <td class="y-bg">
      <div class="mt-radio-inline">
        <label class="mt-radio mt-radio-outline"><input type="radio" name="mobileauto" value="1"> <?php echo L('yes');?> <span></span></label>
        <label class="mt-radio mt-radio-outline"><input type="radio" name="mobileauto" value="0" checked> <?php echo L('no');?> <span></span></label><br><?php echo L('mobile_auto_desc')?>
      </div>
    </td>
  </tr>
  <tr>
    ...
    <td class="y-bg">
      <div class="mt-radio-inline">
        <label class="mt-radio mt-radio-outline"><input type="radio" name="waphtml" value="1"> <?php echo L('yes');?> <span></span></label>
        <label class="mt-radio mt-radio-outline"><input type="radio" name="waphtml" value="0" checked> <?php echo L('no');?> <span></span></label><br><?php echo L('html_wap_desc')?>
      </div>
    </td>
  </tr>
  <tr>
    ...
    <td class="y-bg">
      <div class="mt-radio-inline">
        <label class="mt-radio mt-radio-outline"><input type="radio" name="not_pad" value="1"> <?php echo L('yes');?> <span></span></label>
        <label class="mt-radio mt-radio-outline"><input type="radio" name="not_pad" value="0" checked> <?php echo L('no');?> <span></span></label><br><?php echo L('mobile_not_pad_desc')?>
      </div>
    </td>
  </tr>
  <tr>
    <th><?php echo L('mobile_domain')?>：</th>
    <td class="y-bg"><input type="text" class="input-text" name="mobile_domain" id="mobile_domain" size="70"/></td>
  </tr>
  <tr>
...
<fieldset>
  ...
  <tr>
    ...
    <td class="y-bg"><input type="text" class="input-text" name="site_title" id="site_title" size="80" /></td>
  </tr>
  <tr>
    <th><?php echo L('keyword_name')?>：</th>
    <td class="y-bg"><input type="text" class="input-text" name="keywords" id="keywords" size="80" /></td>
  </tr>
    <tr>
    <th><?php echo L('description')?>：</th>
    <td class="y-bg"><input type="text" class="input-text" name="description" id="description" size="80" /></td>
  </tr>
</table>
</fieldset>
<div class="bk15"></div>
...
<fieldset>
  ...
  <tr>
    ...
    <td class="y-bg"><input type="text" class="input-text" name="setting[imageMaxSize]" id="imageMaxSize" size="10" value="2048"/> KB </td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td class="y-bg"><input type="text" class="input-text" name="setting[catcherMaxSize]" id="catcherMaxSize" size="10" value="2048"/> KB </td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td class="y-bg"><input type="text" class="input-text" name="setting[videoMaxSize]" id="videoMaxSize" size="10" value="102400"/> KB </td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td class="y-bg"><input type="text" class="input-text" name="setting[fileMaxSize]" id="fileMaxSize" size="10" value="51200"/> KB </td>
  </tr>
  <tr>
