...
<div class="col-2 col-auto">
	...
	<div class="content">
	<?php echo L('main_version')?>Phpcms <?php echo PC_VERSION?>  Release <?php echo PC_RELEASE?><br />
...
<div class="col-2 lf mr10" style="width:48%">
	...
	<div class="content">
	<?php echo L('main_product_planning')?><?php echo $designer;?><?php echo $programmer;?><br />
	<?php echo L('main_product_qq_group')?><?php echo $qqgroup;?><br />
	<?php echo L('main_product_qq')?><?php echo $qq;?><br />
	<?php echo L('main_product_tel')?><?php echo $tel;?><br />
	<?php echo L('main_support')?><?php echo $designer;?><?php echo $programmer;?><br>
	<?php echo L('main_download')?><a href="https://gitee.com/zhaoxunzhiyin/" target="_blank">码云Gitee</a><br>
	<?php echo L('main_download')?><a href="https://rep.ue4.net/zhaoxunzhiyin/" target="_blank">有意思代码仓库</a><br>
	<?php echo L('main_download')?><a href="https://github.com/zhaoxunzhiyin/" target="_blank">GayHub</a><br>
	<?php echo L('main_download')?><a href="https://blog.csdn.net/wangzhenkai/article/details/106420429" target="_blank">CSDN博客</a><br>
	<?php echo L('main_download')?><a href="https://www.52pojie.cn/thread-1152136-1-1.html" target="_blank">吾爱破解</a>
	</div>
</div>
<div class="bk10"></div>
</div>
