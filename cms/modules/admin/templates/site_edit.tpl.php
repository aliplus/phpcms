...
<fieldset>
  ...
  <tr>
    ...
    <td class="y-bg"><input type="text" class="input-text" name="name" id="name" size="70" value="<?php echo $data['name']?>" /></td>
  </tr>
  <tr>
    <th><?php echo L('site_dirname')?>：</th>
    <td class="y-bg"><?php if ($siteid == 1) { echo $data['dirname'];} else {?><input type="text" class="input-text" name="dirname" id="dirname" size="70" value="<?php echo $data['dirname']?>" /><?php }?></td>
  </tr>
  <tr>
    <th><?php echo L('site_domain')?>：</th>
    <td class="y-bg"><input type="text" class="input-text" name="domain" id="domain"  size="70" value="<?php echo $data['domain']?>" /></td>
  </tr>
  <tr>
    <th><?php echo L('html_home')?>：</th>
    <td class="y-bg">
      <div class="mt-radio-inline">
        <label class="mt-radio mt-radio-outline"><input type="radio" name="ishtml" value="1"<?php if($data['ishtml']) echo ' checked';?>> <?php echo L('yes');?> <span></span></label>
        <label class="mt-radio mt-radio-outline"><input type="radio" name="ishtml" value="0"<?php if(!$data['ishtml']) echo ' checked';?>> <?php echo L('no');?> <span></span></label>
      </div>
    </td>
  </tr>
</table>
...
<fieldset>
  ...
  <tr>
    ...
    <td class="y-bg">
      <div class="mt-radio-inline">
        <label class="mt-radio mt-radio-outline"><input type="radio" name="mobileauto" value="1"<?php if($data['mobileauto']) echo ' checked';?>> <?php echo L('yes');?> <span></span></label>
        <label class="mt-radio mt-radio-outline"><input type="radio" name="mobileauto" value="0"<?php if(!$data['mobileauto']) echo ' checked';?>> <?php echo L('no');?> <span></span></label><br><?php echo L('mobile_auto_desc')?>
      </div>
    </td>
  </tr>
  <tr>
    <th><?php echo L('html_wap')?>：</th>
    <td class="y-bg">
      <div class="mt-radio-inline">
        <label class="mt-radio mt-radio-outline"><input type="radio" name="waphtml" value="1"<?php if($data['waphtml']) echo ' checked';?>> <?php echo L('yes');?> <span></span></label>
        <label class="mt-radio mt-radio-outline"><input type="radio" name="waphtml" value="0"<?php if(!$data['waphtml']) echo ' checked';?>> <?php echo L('no');?> <span></span></label><br><?php echo L('html_wap_desc')?>
      </div>
    </td>
  </tr>
  <tr>
    ...
    <td class="y-bg">
      <div class="mt-radio-inline">
        <label class="mt-radio mt-radio-outline"><input type="radio" name="not_pad" value="1"<?php if($data['not_pad']) echo ' checked';?>> <?php echo L('yes');?> <span></span></label>
        <label class="mt-radio mt-radio-outline"><input type="radio" name="not_pad" value="0"<?php if(!$data['not_pad']) echo ' checked';?>> <?php echo L('no');?> <span></span></label><br><?php echo L('mobile_not_pad_desc')?>
      </div>
    </td>
  </tr>
  <tr>
    <th><?php echo L('mobile_domain')?>：</th>
    <td class="y-bg"><input type="text" class="input-text" name="mobile_domain" id="mobile_domain" size="70" value="<?php echo $data['mobile_domain']?>" /></td>
  </tr>
  <tr>
...
<fieldset>
  ...
  <tr>
    ...
    <td class="y-bg"><input type="text" class="input-text" name="site_title" id="site_title" size="80" value="<?php echo $data['site_title']?>" /></td>
  </tr>
  <tr>
    <th><?php echo L('keyword_name')?>：</th>
    <td class="y-bg"><input type="text" class="input-text" name="keywords" id="keywords" size="80" value="<?php echo $data['keywords']?>" /></td>
  </tr>
    <tr>
    <th><?php echo L('description')?>：</th>
    <td class="y-bg"><input type="text" class="input-text" name="description" id="description" size="80" value="<?php echo $data['description']?>" /></td>
  </tr>
</table>
</fieldset>
<div class="bk10"></div>
...
<fieldset>
  ...
  <tr class="dr_sy dr_sy_1">
    ...
    <td class="y-bg">
	  ...
	  <?php }?><br><?php echo L('site_att_text_font_desc')?>
     </td>
  </tr>
  <tr class="dr_sy dr_sy_1">
  ...
  <tr class="dr_sy dr_sy_0">
    ...
    <td class="y-bg">
	  ...
	  <?php }?><br><?php echo L('site_att_watermark_img_desc')?>
     </td>
  </tr>
   <tr style="display: none;">
