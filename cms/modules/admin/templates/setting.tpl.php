...
<table width="100%"  class="table_form">
  ...
  <tr>
    ...
    <td class="y-bg">
      <div class="mt-radio-inline">
        <label class="mt-radio mt-radio-outline"><input type="radio" name="setconfig[attachment_stat]" value="1"<?php echo ($attachment_stat=='1') ? ' checked' : ''?>> <?php echo L('setting_yes');?> <span></span></label>
        <label class="mt-radio mt-radio-outline"><input type="radio" name="setconfig[attachment_stat]" value="0"<?php echo ($attachment_stat=='0') ? ' checked' : ''?>> <?php echo L('setting_no');?> <span></span></label>
      </div>
    </td>
  </tr>
  <tr>
...
<table width="100%"  class="table_form">
  ...
  <tr>
    ...
    <td class="y-bg"><input type="text" class="input-text" name="setconfig[baidu_aid]" id="baidu_aid" size="20" value="<?php echo $baidu_aid ?>"/></td>
  </tr>
  <tr>
    <th width="130" valign="top"><?php echo L('setting_keyword_key')?></th>
    <td class="y-bg"><input type="text" class="input-text" name="setconfig[baidu_skey]" id="baidu_skey" size="20" value="<?php echo $baidu_skey ?>"/></td>
  </tr>
  <tr>
    <th width="130" valign="top"><?php echo L('setting_keyword_skey')?></th>
    <td class="y-bg"><input type="text" class="input-text" name="setconfig[baidu_arcretkey]" id="baidu_arcretkey" size="20" value="<?php echo $baidu_arcretkey ?>"/></td>
  </tr>
  <tr>
  ...
  <tr>
    <th width="130" valign="top"><?php echo L('setting_keyword_appid')?></th>
    <td class="y-bg"><input type="text" class="input-text" name="setconfig[xunfei_aid]" id="xunfei_aid" size="20" value="<?php echo $xunfei_aid ?>"/></td>
  </tr>
  <tr>
    <th width="130" valign="top"><?php echo L('setting_keyword_key')?></th>
    <td class="y-bg"><input type="text" class="input-text" name="setconfig[xunfei_skey]" id="xunfei_skey" size="20" value="<?php echo $xunfei_skey ?>"/></td>
  </tr>
  <tr>
