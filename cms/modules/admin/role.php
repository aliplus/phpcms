	...
	public function setting_cat_priv() {
		...
		switch ($op) {
			...
			$str = "<tr>
				  ...
				  <td align='center'><input type='checkbox' name='priv[\$catid][]' \$disabled \$copy_check value='copy' ></td>
				  <td align='center'><input type='checkbox' name='priv[\$catid][]' \$disabled \$recycle_init_check value='recycle_init' ></td>
				  <td align='center'><input type='checkbox' name='priv[\$catid][]' \$disabled \$recycle_check value='recycle' ></td>
			  </tr>";
