...
$LANG['hello'] = '您好！';
$LANG['exit'] = '退出';
$LANG['exit_login'] = '退出登录';
$LANG['confirm_exit_login'] = '你确定要退出吗？';
$LANG['notice'] = '注意';
...
$LANG['main_safety_permissions'] = '※ 建议您将cms目录设置为755（linux）或只读（windows），<a href="http://www.phpip.com/html/2014/changjianwenti_0430/133.html" target="_blank">点击查看教程</a>';
...
$LANG['main_product_team'] = '系统开发';
$LANG['main_product_planning'] = '系统修改：';
$LANG['main_product_dev'] = '系统修改：';
$LANG['main_product_ui'] = 'UI 设计：';
$LANG['main_product_site'] = '官方网站：';
$LANG['main_product_bbs'] = '官方论坛：';
$LANG['main_product_qq_group'] = 'QQ讨论群：';
$LANG['main_product_qq'] = '咨询QQ：';
$LANG['main_product_tel'] = '联系电话：';
$LANG['main_license'] = '授权信息';
$LANG['main_support'] = '技术支持：';
$LANG['main_download'] = '下载地址：';
...
$LANG['setting_keyword'] = '关键词提取';
$LANG['setting_keyword_enable'] = '关键词提取API';
$LANG['setting_default'] = '默认';
$LANG['setting_baidu'] = '百度';
$LANG['setting_xunfei'] = '讯飞';
$LANG['setting_qcnum'] = '分词数量';
$LANG['setting_xunfei_cfg'] = '讯飞关键词';
$LANG['setting_xunfei_enable'] = '讯飞关键词提取API';
$LANG['setting_xunfei_keyword'] = '请先去注册讯飞开放平台账号注册后进入控制台-自然语言处理-关键词提取，免费开通关键词提取服务开通后在信息标题关键词提取可找到您的 【AppID】和【API Key】';
$LANG['setting_baidu_cfg'] = '百度关键词';
$LANG['setting_baidu_qcnum'] = '百度分词数量';
$LANG['setting_baidu_enable'] = '百度关键词提取API';
$LANG['setting_baidu_keyword'] = '请先去百度账号，打开顶部的【管理控制台】找到下面的已开通服务里面的【自然语言处理】，【创建应用】，填【应用名称】和【应用描述】，创建完毕后，打开【查看应用详情】，得到【AppID】【API Key】【Secret Key】。';
$LANG['setting_keyword_register'] = '申请接口';
...
$LANG['fclient_not_exist'] = '子站客户端程序未安装';
$LANG['fclient_not_sn'] = '通信密钥验证为空';
$LANG['fclient_not_id'] = '通信ID验证失败';
$LANG['fclient_sn_exist'] = '通信密钥验证失败';
$LANG['fclient_user_not_role'] = '没有找到本站管理员账号';
$LANG['fclient_sn_succ'] = '授权登录成功';
...
$LANG['database_flush'] = '刷新';
$LANG['database_check'] = '检查';
$LANG['database_showcreat'] = '结构';
$LANG['batch_optimize'] = '批量优化';
$LANG['batch_repair'] = '批量修复';
$LANG['batch_flush'] = '批量刷新';
$LANG['batch_check'] = '批量检查';
$LANG['batch_utf8'] = '转换为utf8编码';
$LANG['database_cache'] = '数据缓存不存在';
$LANG['database_table'] = '表信息读取失败';
$LANG['database_no_table'] = '没有选择表';
$LANG['database_success'] = '完成';
...
<B>互联网新闻开放协议：</B> <br>
1、互联网新闻开放协议》是百度新闻搜索制定的搜索引擎新闻源收录标准，网站可将发布的新闻内容制作成遵循此开放协议的XML格式的网页（独立于原有的新闻发布形式）供搜索引擎索引。 CMS可自动生成网站的Sitemaps，但是您还需要向google或者baidu提交Sitemaps的访问地址。<br>
您的网站的Sitemaps 访问地址为：<?=APP_PATH?>sitemaps.xml<br>
CMS可自动生成网站的<<互联网新闻开放协议>>，但是您还需要向baidu提交访问地址。<br>
...
$LANG['domain_name_format'] = '域名可为空，格式应该为http://www.kaixin100.cn/';
$LANG['domain_end_string'] = '格式应该为http://www.kaixin100.cn/，请以‘/’结束';
...
$LANG['mobile_configuration'] = '手机配置';
$LANG['open'] = '开启';
$LANG['close'] = '关闭';
...
$LANG['html_home'] = '首页静态';
$LANG['mobile_domain'] = '手机域名';
$LANG['mobile_auto'] = '自动识别';
$LANG['mobile_auto_desc'] = '未绑定移动端域名时自动识别移动端终端模板；绑定移动端域名时自动跳转到移动端域名上';
$LANG['html_wap'] = '生成静态';
$LANG['html_wap_desc'] = '当PC端执行生成静态命令时，移动端也会生成相应的静态文件；关闭表示移动端不生成静态文件';
$LANG['mobile_not_pad'] = '将平板端排除';
$LANG['mobile_not_pad_desc'] = '平板端访问时不会识别为移动端界面，平板将访问PC界面';
$LANG['mobile_template'] = '模板路径';
$LANG['mobile_template_style'] = '/模板目录/wap/';
...
$LANG['site_domain_ex'] = '请填写域名，格式为：http://www.kaixin100.cn/';
$LANG['site_domain_ex2'] = '格式应该为http://www.kaixin100.cn/，请以‘/’结束';
...
$LANG['att_ueditor'] = 'Ueditor编辑器上传配置';
$LANG['ueditor_filename'] = '文件名格式';
$LANG['ueditor_filename_desc'] = '{filename}：会替换成文件名 （要注意中文文件乱码问题）、{rand:6}：会替换成随机数,后面的数字是随机数的位数、{time}：会替换成时间戳、{yyyy}：会替换成四位年份、{yy}：会替换成两位年份、{mm}：会替换成两位月份、{dd}：会替换成两位日期、{hh}：会替换成两位小时、{ii}：会替换成两位分钟、{ss}：会替换成两位秒、非法字符：\ : * ? " < > |';
$LANG['ueditor_image_max_size'] = '允许上传图片大小';
$LANG['ueditor_image_allow_ext'] = '允许上传图片类型';
$LANG['ueditor_catcher_max_size'] = '抓取远程图片大小';
$LANG['ueditor_catcher_allow_ext'] = '抓取远程图片类型';
$LANG['ueditor_video_max_size'] = '允许上传视频大小';
$LANG['ueditor_video_allow_ext'] = '允许上传视频类型';
$LANG['ueditor_file_max_size'] = '允许上传文件大小';
$LANG['ueditor_file_allow_ext'] = '允许上传文件类型';
$LANG['ueditor_imagemanager_max_size'] = '每次列出图片数量';
$LANG['ueditor_imagemanager_allow_ext'] = '列出图片类型';
$LANG['ueditor_filemanager_max_size'] = '每次列出文件数量';
$LANG['ueditor_filemanager_allow_ext'] = '列出文件类型';
$LANG['ueditor_videomanager_max_size'] = '每次列出视频数量';
$LANG['ueditor_videomanager_allow_ext'] = '列出视频类型';
...
$LANG['site_att_watermark_type'] = '水印类型';
$LANG['site_att_photo'] = '图片';
$LANG['site_att_text'] = '文字';
$LANG['site_att_text_font'] = '文字字体';
$LANG['site_att_text_font_desc'] = '自定义字体文件./statics/images/water/font/';
$LANG['site_att_watermark_text'] = '水印文字';
$LANG['site_att_text_desc'] = '如果为中文，先要font目录中添加中文字体';
$LANG['site_att_text_size'] = '水印文字大小';
$LANG['site_att_text_size_desc'] = '字体大小，单位px像素';
$LANG['site_att_text_color'] = '水印文字颜色';
$LANG['site_att_watermark_condition'] = '水印添加条件';
$LANG['site_att_watermark_img'] = '水印图片';
$LANG['site_att_watermark_img_desc'] = '自定义图片水印文件./statics/images/water/';
$LANG['site_att_watermark_photo'] = '图片大小限制';
$LANG['site_att_watermark_photo_desc'] = '对超过设定值的图片附件加水印，例如小尺寸的图片不水印';
$LANG['site_att_watermark_minwidth'] = '宽大于';
$LANG['site_att_watermark_minheight'] = '高大于';
$LANG['site_att_watermark_pct'] = '水印透明度';
$LANG['site_att_watermark_pct_desc'] = '设置水印图标透明度，数值越大，图标越清晰';
$LANG['site_att_watermark_quality'] = '水印图片质量';
$LANG['site_att_watermark_quality_desc'] = '设置添加水印后的图片质量，数值越大，图片越清晰';
$LANG['site_att_watermark_padding'] = '水印图片内边距';
$LANG['site_att_watermark_padding_desc'] = '内边距，以像素为单位，是水印与图片边缘之间的距离';
$LANG['site_att_watermark_offset'] = '水印图片偏移量';
$LANG['site_att_watermark_hor_offset'] = '水平';
$LANG['site_att_watermark_vrt_offset'] = '垂直';
$LANG['site_att_ueditor'] = '编辑器水印';
$LANG['site_att_watermark_ueditor'] = '按编辑器属性';
$LANG['site_att_watermark_all'] = '全部水印';
$LANG['site_att_ueditor_desc'] = '是否对编辑器上传的图片进行强制水印';
$LANG['site_att_watermark_review'] = '预览水印';
$LANG['site_att_watermark_pos'] = '水印位置';
$LANG['site_att_watermark_pos_1'] = '左上';
$LANG['site_att_watermark_pos_2'] = '中上';
$LANG['site_att_watermark_pos_3'] = '右上';
$LANG['site_att_watermark_pos_4'] = '左中';
$LANG['site_att_watermark_pos_5'] = '正中';
$LANG['site_att_watermark_pos_6'] = '右中';
$LANG['site_att_watermark_pos_7'] = '左下';
$LANG['site_att_watermark_pos_8'] = '中下';
$LANG['site_att_watermark_pos_9'] = '右下';
...
$LANG['lockscreen_status_password'] = '请输入解锁密码';
$LANG['setting_input_password'] = '请输入密码解锁！';
$LANG['setting_scroll'] = '使用鼠标滚轴滚动侧栏';
